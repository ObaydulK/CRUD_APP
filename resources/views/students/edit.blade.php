                        ...
                        <div class="lg:col-span-2">
                            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="City" id="City" value="{{$student->City}}" required
                                        class="h-10 border mt-1 rounded px-4 w-full bg-gray-50"  
                                        placeholder="" />
                                </div>
                                <div class="md:col-span-3">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="Gender" id="Gender" value="{{$student->Gender}}" required
                                        class="h-10 border mt-1 rounded px-4 w-full bg-gray-50"  
                                         />
                                </div>
                                <div class="md:col-span-5">
                                    ...
                                    <textarea type="text" name="Bio" id="Bio" required
                                        class="h-10 border mt-1 rounded px-4 w-full bg-gray-50"  
                                        placeholder="">{{$student->Bio}} </textarea>
                                </div>
